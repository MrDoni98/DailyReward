...
class Main extends PluginBase implements Listener{
	public function onEnable(){
		...
		$this->config = new Config($this->getDataFolder(). "config.yml", Config::YAML, array("first_join" => "[DailyReward] Здравствуйте, вы первый день на сервере.", "daily_join" => "[DailyReward] Здравствуйте, Вы играете на сервере уже {count} день подряд."));
